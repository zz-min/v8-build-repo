...
#include <map>
#include <cstdlib>
#include "kr_co_coocon_v8_V8Impl.h"
...
JNIEXPORT jstring JNICALL Java_kr_co_coocon_v8_V8__1getVersion (JNIEnv *env, jclass) {
  const char* utfString = v8::V8::GetVersion();
  return env->NewStringUTF(utfString);
}


// JNIEXPORT jstring JNICALL Java_kr_co_coocon_v8_V8__1getConstructorName
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void*) {
    ...
    jvm = vm;
    v8cls = (jclass)env->NewGlobalRef((env)->FindClass("kr/co/coocon/v8/V8"));
    // v8InspectorCls = (jclass)env->NewGlobalRef((env)->FindClass("kr/co/coocon/v8/inspector/V8Inspector"));
    // v8InspectorDelegateCls = (jclass)env->NewGlobalRef((env)->FindClass("kr/co/coocon/v8/inspector/V8InspectorDelegate"));
    v8ObjectCls = (jclass)env->NewGlobalRef((env)->FindClass("kr/co/coocon/v8/V8Object"));
    v8ArrayCls = (jclass)env->NewGlobalRef((env)->FindClass("kr/co/coocon/v8/V8Array"));
    v8TypedArrayCls = (jclass)env->NewGlobalRef((env)->FindClass("kr/co/coocon/v8/V8TypedArray"));
    v8ArrayBufferCls = (jclass)env->NewGlobalRef((env)->FindClass("kr/co/coocon/v8/V8ArrayBuffer"));
    v8FunctionCls = (jclass)env->NewGlobalRef((env)->FindClass("kr/co/coocon/v8/V8Function"));
    undefinedV8ObjectCls = (jclass)env->NewGlobalRef((env)->FindClass("kr/co/coocon/v8/V8Object$Undefined"));
    undefinedV8ArrayCls = (jclass)env->NewGlobalRef((env)->FindClass("kr/co/coocon/v8/V8Array$Undefined"));
    ...
    v8ResultsUndefinedCls = (jclass)env->NewGlobalRef((env)->FindClass("kr/co/coocon/v8/V8ResultUndefined"));
    v8ScriptCompilationCls = (jclass)env->NewGlobalRef((env)->FindClass("kr/co/coocon/v8/V8ScriptCompilationException"));
    v8ScriptExecutionException = (jclass)env->NewGlobalRef((env)->FindClass("kr/co/coocon/v8/V8ScriptExecutionException"));
    v8RuntimeExceptionCls = (jclass)env->NewGlobalRef((env)->FindClass("kr/co/coocon/v8/V8RuntimeException"));
    ...
    // Get all method IDs
    v8ArrayInitMethodID = env->GetMethodID(v8ArrayCls, "<init>", "(Lkr/co/coocon/v8/V8;)V");
	  v8TypedArrayInitMethodID = env->GetMethodID(v8TypedArrayCls, "<init>", "(Lkr/co/coocon/v8/V8;)V");
    v8ArrayBufferInitMethodID = env->GetMethodID(v8ArrayBufferCls, "<init>", "(Lkr/co/coocon/v8/V8;Ljava/nio/ByteBuffer;)V");
    v8ArrayGetHandleMethodID = env->GetMethodID(v8ArrayCls, "getHandle", "()J");
    v8CallVoidMethodID = (env)->GetMethodID(v8cls, "callVoidJavaMethod", "(JLkr/co/coocon/v8/V8Object;Lkr/co/coocon/v8/V8Array;)V");
    ...
    v8CallObjectJavaMethodMethodID = (env)->GetMethodID(v8cls, "callObjectJavaMethod", "(JLkr/co/coocon/v8/V8Object;Lkr/co/coocon/v8/V8Array;)Ljava/lang/Object;");
    ...
    v8FunctionInitMethodID = env->GetMethodID(v8FunctionCls, "<init>", "(Lkr/co/coocon/v8/V8;)V");
    v8ObjectInitMethodID = env->GetMethodID(v8ObjectCls, "<init>", "(Lkr/co/coocon/v8/V8;)V");
...
JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1setFlags
...
JNIEXPORT jlong JNICALL Java_kr_co_coocon_v8_V8__1getBuildID
  (JNIEnv *, jclass) {
  return 2;
}

JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1startNodeJS
  (JNIEnv * env, jclass, jlong, jstring) {
    (env)->ThrowNew(unsupportedOperationExceptionCls, "startNodeJS Not Supported.");
}

JNIEXPORT jboolean JNICALL Java_kr_co_coocon_v8_V8__1pumpMessageLoop
  (JNIEnv * env, jclass, jlong) {
    (env)->ThrowNew(unsupportedOperationExceptionCls, "pumpMessageLoop Not Supported.");
 return false;
}

JNIEXPORT jboolean JNICALL Java_kr_co_coocon_v8_V8__1isRunning
  (JNIEnv *env, jclass, jlong v8RuntimePtr) {
 (env)->ThrowNew(unsupportedOperationExceptionCls, "isRunning Not Supported.");
 return false;
}

JNIEXPORT jboolean JNICALL Java_kr_co_coocon_v8_V8__1isNodeCompatible
  (JNIEnv * env, jclass) {
    (env)->ThrowNew(unsupportedOperationExceptionCls, "isNodeCompatible Not Supported.");
   return false;
}

JNIEXPORT jlong JNICALL Java_kr_co_coocon_v8_V8__1createIsolate
...
// JNIEXPORT jlong JNICALL Java_kr_co_coocon_v8_V8__1createInspector
...
// JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1dispatchProtocolMessage
...
// JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1schedulePauseOnNextStatement
...
JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1acquireLock
...
JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1releaseLock
  (JNIEnv *env, jobject, jlong v8RuntimePtr) {
  V8Runtime* runtime = reinterpret_cast<V8Runtime*>(v8RuntimePtr);
    if(runtime->isolate->InContext()) {
...
JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1lowMemoryNotification
  (JNIEnv*, jobject, jlong v8RuntimePtr) {
  V8Runtime* runtime = reinterpret_cast<V8Runtime*>(v8RuntimePtr);
  runtime->isolate->LowMemoryNotification();
}

JNIEXPORT jlong JNICALL Java_kr_co_coocon_v8_V8__1initEmptyContainer
(JNIEnv *env, jobject, jlong v8RuntimePtr) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, 0)
...
JNIEXPORT jlong JNICALL Java_kr_co_coocon_v8_V8__1initNewV8Object
(JNIEnv *env, jobject, jlong v8RuntimePtr) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, 0)
...
JNIEXPORT jlong JNICALL Java_kr_co_coocon_v8_V8__1getGlobalObject
  (JNIEnv *env, jobject, jlong v8RuntimePtr) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, 0)
  return reinterpret_cast<jlong>(reinterpret_cast<V8Runtime*>(v8RuntimePtr)->globalObject);
}

JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1createTwin
...
JNIEXPORT jlong JNICALL Java_kr_co_coocon_v8_V8__1initNewV8Array
(JNIEnv *env, jobject, jlong v8RuntimePtr) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, 0)
...
JNIEXPORT jlong JNICALL Java_kr_co_coocon_v8_V8__1initNewV8Int8Array
...
JNIEXPORT jlong JNICALL Java_kr_co_coocon_v8_V8__1initNewV8UInt8Array
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, 0)
  Handle<ArrayBuffer> arrayBuffer = Local<ArrayBuffer>::New(isolate, *reinterpret_cast<Persistent<ArrayBuffer>*>(bufferHandle));
...
JNIEXPORT jlong JNICALL Java_kr_co_coocon_v8_V8__1initNewV8UInt8ClampedArray
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, 0)
  Handle<ArrayBuffer> arrayBuffer = Local<ArrayBuffer>::New(isolate, *reinterpret_cast<Persistent<ArrayBuffer>*>(bufferHandle));
...
JNIEXPORT jlong JNICALL Java_kr_co_coocon_v8_V8__1initNewV8Int32Array
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, 0)
  Handle<ArrayBuffer> arrayBuffer = Local<ArrayBuffer>::New(isolate, *reinterpret_cast<Persistent<ArrayBuffer>*>(bufferHandle));
...
JNIEXPORT jlong JNICALL Java_kr_co_coocon_v8_V8__1initNewV8UInt32Array
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, 0)
  Handle<ArrayBuffer> arrayBuffer = Local<ArrayBuffer>::New(isolate, *reinterpret_cast<Persistent<ArrayBuffer>*>(bufferHandle));
...
JNIEXPORT jlong JNICALL Java_kr_co_coocon_v8_V8__1initNewV8UInt16Array
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, 0)
  Handle<ArrayBuffer> arrayBuffer = Local<ArrayBuffer>::New(isolate, *reinterpret_cast<Persistent<ArrayBuffer>*>(bufferHandle));
...
JNIEXPORT jlong JNICALL Java_kr_co_coocon_v8_V8__1initNewV8Int16Array
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, 0)
  Handle<ArrayBuffer> arrayBuffer = Local<ArrayBuffer>::New(isolate, *reinterpret_cast<Persistent<ArrayBuffer>*>(bufferHandle));
...
JNIEXPORT jlong JNICALL Java_kr_co_coocon_v8_V8__1initNewV8Float32Array
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, 0)
  Handle<ArrayBuffer> arrayBuffer = Local<ArrayBuffer>::New(isolate, *reinterpret_cast<Persistent<ArrayBuffer>*>(bufferHandle));
...
JNIEXPORT jlong JNICALL Java_kr_co_coocon_v8_V8__1initNewV8Float64Array
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, 0)
  Handle<ArrayBuffer> arrayBuffer = Local<ArrayBuffer>::New(isolate, *reinterpret_cast<Persistent<ArrayBuffer>*>(bufferHandle));
...
JNIEXPORT jlong JNICALL Java_kr_co_coocon_v8_V8__1initNewV8ArrayBuffer__JI
...
JNIEXPORT jlong JNICALL Java_kr_co_coocon_v8_V8__1initNewV8ArrayBuffer__JLjava_nio_ByteBuffer_2I
...
JNIEXPORT jobject JNICALL Java_kr_co_coocon_v8_V8__1createV8ArrayBufferBackingStore
...
JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1release
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
  if (v8RuntimePtr == 0) {
    return;
  }
...
JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1terminateExecution
  (JNIEnv * env, jobject, jlong v8RuntimePtr) {
	if (v8RuntimePtr == 0) {
	  return;
	}
...
JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1releaseRuntime
(JNIEnv *env, jobject, jlong v8RuntimePtr) {
  if (v8RuntimePtr == 0) {
    return;
  }
...
JNIEXPORT jboolean JNICALL Java_kr_co_coocon_v8_V8__1contains
...
JNIEXPORT jobjectArray JNICALL Java_kr_co_coocon_v8_V8__1getKeys
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
...
JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1executeVoidScript
...
JNIEXPORT jdouble JNICALL Java_kr_co_coocon_v8_V8__1executeDoubleScript
(JNIEnv * env, jobject v8, jlong v8RuntimePtr, jstring jjstring, jstring jscriptName = nullptr, jint jlineNumber = 0) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, 0)
  TryCatch tryCatch(isolate);
  Local<Script> script;
...
JNIEXPORT jboolean JNICALL Java_kr_co_coocon_v8_V8__1executeBooleanScript
(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jstring jjstring, jstring jscriptName = nullptr, jint jlineNumber = 0) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, false)
  TryCatch tryCatch(isolate);
  Local<Script> script;
...
JNIEXPORT jstring JNICALL Java_kr_co_coocon_v8_V8__1executeStringScript
(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jstring jjstring, jstring jscriptName = nullptr, jint jlineNumber = 0) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, NULL)
  TryCatch tryCatch(isolate);
  Local<Script> script;
...
JNIEXPORT jint JNICALL Java_kr_co_coocon_v8_V8__1executeIntegerScript
(JNIEnv * env, jobject v8, jlong v8RuntimePtr, jstring jjstring, jstring jscriptName = nullptr, jint jlineNumber = 0) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, 0)
  TryCatch tryCatch(isolate);
  Local<Script> script;
...
JNIEXPORT jobject JNICALL Java_kr_co_coocon_v8_V8__1executeScript
...
JNIEXPORT jobject JNICALL Java_kr_co_coocon_v8_V8__1executeFunction__JJJJ
  (JNIEnv *env, jobject v8, jlong v8RuntimePtr, jlong receiverHandle, jlong functionHandle, jlong parameterHandle) {
    ...
    if (!invokeFunction(env, context, isolate, v8RuntimePtr, receiverHandle, functionHandle, parameterHandle, result))
        return nullptr;
    return getResult(env, context, v8, v8RuntimePtr, result, kr_co_coocon_v8_V8_UNKNOWN);
}

JNIEXPORT jobject JNICALL Java_kr_co_coocon_v8_V8__1executeFunction__JIJLjava_lang_String_2J
...
JNIEXPORT jint JNICALL Java_kr_co_coocon_v8_V8__1executeIntegerFunction
...
JNIEXPORT jdouble JNICALL Java_kr_co_coocon_v8_V8__1executeDoubleFunction
(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jlong objectHandle, jstring jfunctionName, jlong parameterHandle) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
  Handle<Value> result;
  if (!invokeFunction(env, context, isolate, v8RuntimePtr, objectHandle, jfunctionName, parameterHandle, result))
...
JNIEXPORT jboolean JNICALL Java_kr_co_coocon_v8_V8__1executeBooleanFunction
(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jlong objectHandle, jstring jfunctionName, jlong parameterHandle) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, false);
  Handle<Value> result;
  if (!invokeFunction(env, context, isolate, v8RuntimePtr, objectHandle, jfunctionName, parameterHandle, result))
...
JNIEXPORT jstring JNICALL Java_kr_co_coocon_v8_V8__1executeStringFunction
(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jlong objectHandle, jstring jfunctionName, jlong parameterHandle) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, NULL)
  Handle<Value> result;
  if (!invokeFunction(env, context, isolate, v8RuntimePtr, objectHandle, jfunctionName, parameterHandle, result))
...
JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1executeVoidFunction
(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jlong objectHandle, jstring jfunctionName, jlong parameterHandle) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, );
  Handle<Value> result;
...
JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1addUndefined
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, );
  addValueWithKey(env, context, isolate, v8RuntimePtr, objectHandle, key, Undefined(isolate));
}

JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1addNull
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, );
  addValueWithKey(env, context, isolate, v8RuntimePtr, objectHandle, key, Null(isolate));
}

JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1add__JJLjava_lang_String_2I
...
JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1add__JJLjava_lang_String_2D
...
JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1add__JJLjava_lang_String_2Ljava_lang_String_2
...
JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1add__JJLjava_lang_String_2Z
...
JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1addObject
...
JNIEXPORT jobject JNICALL Java_kr_co_coocon_v8_V8__1get
...
JNIEXPORT jint JNICALL Java_kr_co_coocon_v8_V8__1getInteger
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
...
JNIEXPORT jdouble JNICALL Java_kr_co_coocon_v8_V8__1getDouble
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
  Handle<Value> v8Value = getValueWithKey(env, context, isolate, v8RuntimePtr, objectHandle, key);
  ASSERT_IS_NUMBER(v8Value);
...
JNIEXPORT jstring JNICALL Java_kr_co_coocon_v8_V8__1getString
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
  Handle<Value> v8Value = getValueWithKey(env, context, isolate, v8RuntimePtr, objectHandle, key);
...
JNIEXPORT jboolean JNICALL Java_kr_co_coocon_v8_V8__1getBoolean
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, false);
  Handle<Value> v8Value = getValueWithKey(env, context, isolate, v8RuntimePtr, objectHandle, key);
...
JNIEXPORT jint JNICALL Java_kr_co_coocon_v8_V8__1getType__JJLjava_lang_String_2
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
  Handle<Value> v8Value = getValueWithKey(env, context, isolate, v8RuntimePtr, objectHandle, key);
...
bool isNumber(int type) {
  return type == kr_co_coocon_v8_V8_DOUBLE || type == kr_co_coocon_v8_V8_INTEGER;
}

bool isObject(int type) {
  return type == kr_co_coocon_v8_V8_V8_OBJECT || type == kr_co_coocon_v8_V8_V8_ARRAY;
}
...
JNIEXPORT jint JNICALL Java_kr_co_coocon_v8_V8__1getArrayType
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
  ...
  if ( array->IsTypedArray() ) {
      if ( array->IsFloat64Array() ) {
        return kr_co_coocon_v8_V8_DOUBLE;
      } else if ( array->IsFloat32Array() ) {
        return kr_co_coocon_v8_V8_FLOAT_32_ARRAY;
      } else if ( array->IsInt32Array() ) {
        return kr_co_coocon_v8_V8_INT_32_ARRAY;
      } else if ( array->IsUint32Array() ) {
        return kr_co_coocon_v8_V8_UNSIGNED_INT_32_ARRAY;
      } else if ( array->IsInt16Array() ) {
        return kr_co_coocon_v8_V8_INT_16_ARRAY;
      } else if ( array->IsUint16Array() ) {
        return kr_co_coocon_v8_V8_UNSIGNED_INT_16_ARRAY;
      } else if ( array->IsInt8Array() ) {
        return kr_co_coocon_v8_V8_INT_8_ARRAY;
      } else if ( array->IsUint8Array() ) {
        return kr_co_coocon_v8_V8_UNSIGNED_INT_8_ARRAY;
      } else if ( array->IsUint8ClampedArray() ) {
        return kr_co_coocon_v8_V8_UNSIGNED_INT_8_CLAMPED_ARRAY;
      }
      return kr_co_coocon_v8_V8_INTEGER;
  } else {
      length = Array::Cast(*array)->Length();
  }
  int arrayType = kr_co_coocon_v8_V8_UNDEFINED;
  for (int index = 0; index < length; index++) {
    ...
    if (type < 0) {
      ...
      arrayType = kr_co_coocon_v8_V8_DOUBLE;
    }
    else if (isObject(arrayType, type)) {
      arrayType = kr_co_coocon_v8_V8_V8_OBJECT;
    }
    else {
      return kr_co_coocon_v8_V8_UNDEFINED;
    }
  }
  return arrayType;
}

JNIEXPORT jint JNICALL Java_kr_co_coocon_v8_V8__1arrayGetSize
...
JNIEXPORT jint JNICALL Java_kr_co_coocon_v8_V8__1arrayGetInteger
...
JNIEXPORT jint JNICALL Java_kr_co_coocon_v8_V8__1arrayGetIntegers__JJII_3I
...
JNIEXPORT jintArray JNICALL Java_kr_co_coocon_v8_V8__1arrayGetIntegers__JJII
...
JNIEXPORT jint JNICALL Java_kr_co_coocon_v8_V8__1arrayGetDoubles__JJII_3D
...
JNIEXPORT jdoubleArray JNICALL Java_kr_co_coocon_v8_V8__1arrayGetDoubles__JJII
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
  Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jint JNICALL Java_kr_co_coocon_v8_V8__1arrayGetBooleans__JJII_3Z
...
JNIEXPORT jbyteArray JNICALL Java_kr_co_coocon_v8_V8__1arrayGetBytes__JJII
  (JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
  Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jbooleanArray JNICALL Java_kr_co_coocon_v8_V8__1arrayGetBooleans__JJII
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
  Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jint JNICALL Java_kr_co_coocon_v8_V8__1arrayGetBytes__JJII_3B
...
JNIEXPORT jint JNICALL Java_kr_co_coocon_v8_V8__1arrayGetStrings__JJII_3Ljava_lang_String_2
...
JNIEXPORT jobjectArray JNICALL Java_kr_co_coocon_v8_V8__1arrayGetStrings__JJII
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
  Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jboolean JNICALL Java_kr_co_coocon_v8_V8__1arrayGetBoolean
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint index) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, false);
  Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
  Handle<Value> v8Value = array->Get(context, index).ToLocalChecked();
...
JNIEXPORT jbyte JNICALL Java_kr_co_coocon_v8_V8__1arrayGetByte
  (JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint index) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, false);
  Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
  Handle<Value> v8Value = array->Get(context, index).ToLocalChecked();
...
JNIEXPORT jdouble JNICALL Java_kr_co_coocon_v8_V8__1arrayGetDouble
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint index) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
  Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
  Handle<Value> v8Value = array->Get(context, index).ToLocalChecked();
...
JNIEXPORT jstring JNICALL Java_kr_co_coocon_v8_V8__1arrayGetString
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint index) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
  Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
  Handle<Value> v8Value = array->Get(context, index).ToLocalChecked();
...
JNIEXPORT jobject JNICALL Java_kr_co_coocon_v8_V8__1arrayGet
...
JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1addArrayNullItem
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, );
  Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
  if ( array->IsTypedArray() ) {
...
JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1addArrayUndefinedItem
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, );
  Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
  if ( array->IsTypedArray() ) {
...
JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1addArrayIntItem
...
JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1addArrayDoubleItem
...
JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1addArrayBooleanItem
...
JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1addArrayStringItem
...
JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1addArrayObjectItem
...
int getType(Handle<Value> v8Value) {
  if (v8Value.IsEmpty() || v8Value->IsUndefined()) {
    ...
    return kr_co_coocon_v8_V8_NULL;
  }
    ...
    return kr_co_coocon_v8_V8_BOOLEAN;
  }
  else if (v8Value->IsString()) {
    return kr_co_coocon_v8_V8_STRING;
  }
  else if (v8Value->IsFunction()) {
    return kr_co_coocon_v8_V8_V8_FUNCTION;
  }
  else if (v8Value->IsArrayBuffer()) {
    return kr_co_coocon_v8_V8_V8_ARRAY_BUFFER;
  }
  else if (v8Value->IsTypedArray()) {
    return kr_co_coocon_v8_V8_V8_TYPED_ARRAY;
  }
  else if (v8Value->IsArray()) {
    return kr_co_coocon_v8_V8_V8_ARRAY;
  }
  else if (v8Value->IsObject()) {
    return kr_co_coocon_v8_V8_V8_OBJECT;
  }
  return -1;
}

JNIEXPORT jint JNICALL Java_kr_co_coocon_v8_V8__1getType__JJI
...
JNIEXPORT jint JNICALL Java_kr_co_coocon_v8_V8__1getType__JJ
  (JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, 0)
...
JNIEXPORT jint JNICALL Java_kr_co_coocon_v8_V8__1getType__JJII
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, 0)
  Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
  int result = -1;
...
void voidCallback(const FunctionCallbackInfo<Value>& args) {
  ...
  jobject jreceiver = getResult(env, context, v8, md->v8RuntimePtr, receiver, kr_co_coocon_v8_V8_UNKNOWN);
...
void objectCallback(const FunctionCallbackInfo<Value>& args) {
  ...
  if (env->ExceptionCheck()) {
    ...
    if (returnType == kr_co_coocon_v8_V8_INTEGER) {
      args.GetReturnValue().Set(getInteger(env, resultObject));
    }
    else if (returnType == kr_co_coocon_v8_V8_BOOLEAN) {
      args.GetReturnValue().Set(getBoolean(env, resultObject));
    }
    else if (returnType == kr_co_coocon_v8_V8_DOUBLE) {
      args.GetReturnValue().Set(getDouble(env, resultObject));
    }
    else if (returnType == kr_co_coocon_v8_V8_STRING) {
    ...
    else if (returnType == kr_co_coocon_v8_V8_V8_ARRAY) {
    ...
    else if (returnType == kr_co_coocon_v8_V8_V8_OBJECT) {
      if (isUndefined(env, resultObject)) {
        args.GetReturnValue().SetUndefined();
      }
      else {
    ...
    else if (returnType == kr_co_coocon_v8_V8_V8_ARRAY_BUFFER) {
      if (isUndefined(env, resultObject)) {
        args.GetReturnValue().SetUndefined();
      }
      else {
...
JNIEXPORT jlongArray JNICALL Java_kr_co_coocon_v8_V8__1initNewV8Function
(JNIEnv *env, jobject, jlong v8RuntimePtr) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
...
JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1setWeak
  (JNIEnv * env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
...
// JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1clearWeak
//   (JNIEnv * env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
//     Isolate* isolate = SETUP(env, v8RuntimePtr, )
//     reinterpret_cast<Persistent<Object>*>(objectHandle)->ClearWeak();
// }

JNIEXPORT jboolean JNICALL Java_kr_co_coocon_v8_V8__1isWeak
  (JNIEnv * env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0)
    return reinterpret_cast<Persistent<Object>*>(objectHandle)->IsWeak();
}

JNIEXPORT jlong JNICALL Java_kr_co_coocon_v8_V8__1registerJavaMethod
...
JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1releaseMethodDescriptor
  (JNIEnv *, jobject, jlong, jlong methodDescriptorPtr) {
  MethodDescriptor* md = reinterpret_cast<MethodDescriptor*>(methodDescriptorPtr);
  delete(md);
}

JNIEXPORT void JNICALL Java_kr_co_coocon_v8_V8__1setPrototype
...
JNIEXPORT jboolean JNICALL Java_kr_co_coocon_v8_V8__1equals
...
JNIEXPORT jstring JNICALL Java_kr_co_coocon_v8_V8__1toString
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
  Handle<Object> object = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
...
JNIEXPORT jboolean JNICALL Java_kr_co_coocon_v8_V8__1strictEquals
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jlong thatHandle) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, false);
  Handle<Object> object = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
...
JNIEXPORT jboolean JNICALL Java_kr_co_coocon_v8_V8__1sameValue
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jlong thatHandle) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, false);
  Handle<Object> object = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
  Handle<Object> that = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
...
JNIEXPORT jint JNICALL Java_kr_co_coocon_v8_V8__1identityHash
(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
  Isolate* isolate = SETUP(env, v8RuntimePtr, false);
  Handle<Object> object = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
  if (objectHandle == reinterpret_cast<jlong>(runtime->globalObject)) {
...
jobject getResult(JNIEnv *env, const Local<Context>& context, jobject &v8, jlong v8RuntimePtr, Handle<Value> &result, jint expectedType) {
  ...
  if (result->IsUndefined() && expectedType == kr_co_coocon_v8_V8_V8_ARRAY) {
    jobject objectResult = env->NewObject(undefinedV8ArrayCls, undefinedV8ArrayInitMethodID, v8);
    return objectResult;
  }
  else if (result->IsUndefined() && (expectedType == kr_co_coocon_v8_V8_V8_OBJECT || expectedType == kr_co_coocon_v8_V8_NULL)) {
